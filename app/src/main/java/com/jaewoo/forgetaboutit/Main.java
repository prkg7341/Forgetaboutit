...
public class Main extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Button renew = (Button) view.findViewById(R.id.button);
        final TextView weather = (TextView) view.findViewById(R.id.weather);
        RunningAsyncTask rat = new RunningAsyncTask(weather);
        rat.execute();
        renew.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                new Main.RunningAsyncTask(weather);
            }
        });
        return view;
    }
    ...
    class RunningAsyncTask extends AsyncTask<String, String, String> {//동네예보
        ...
        public RunningAsyncTask(View view){
